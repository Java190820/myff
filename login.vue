...
<style scoped="scoped">
    ...
    .dv_login{
      height: 500px;background-image: url();background-position: -500px -100px;
      background-size: 100%;
           ...
           <tr>
               <td>
                 <input type="text" v-model="keycode"
                  class="form-control pull-left"  placeholder="验证码"
                   ...
                   <img @click="changeKeycode($event)" id="sys_keycode" class="pull-left" src="http://127.0.0.1:8090/backstage/defaultKaptcha" />
              ...
              <tr>
                  <td>
                   ...
                   <button class="btn btn-danger btn-block" @click="zhuce()"
  ...
  export default{
    ...
    ,methods:{
      ...
      changeKeycode(event){
        ...
        event.target.src="http://127.0.0.1:8090/backstage/defaultKaptcha";
